...
namespace tourBD.Membership.Seeds
{
    public class AuthoritySeed : DataSeed
    {
            ...
            : base(dbContext)
        {
            ...
            _adminUser = new ApplicationUser("kshuvo96@gmail.com", "Kawsarul Alam", "01764206806", "kshuvo96@gmail.com", @"\img\avatar.png");
            _supportUser = new ApplicationUser("mahin@gmail.com", "Mahin Hosen", "01789577996", "mahin@gmail.com", @"\img\avatar.png");
            _marketingUser = new ApplicationUser("arif@gmail.com", "Ariful Islam", "01688032774", "arif@gmail.com", @"\img\avatar.png");
